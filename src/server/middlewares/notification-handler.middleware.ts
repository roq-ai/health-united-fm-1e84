...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'patient.update': {
    roles: ['hospital-administrator', 'medical-staff', 'data-analyst'],
    key: 'patient-feedback-submitted',
    tenantPath: ['hospital', 'user', 'patient'],
    userPath: [],
  },
  'medical_staff.update': {
    roles: ['hospital-administrator', 'patient'],
    key: 'feedback-response',
    tenantPath: ['hospital', 'user', 'medical_staff'],
    userPath: [],
  },
  'system_administrator.update': {
    roles: ['hospital-administrator'],
    key: 'data-security-update',
    tenantPath: ['hospital', 'user', 'system_administrator'],
    userPath: [],
  },
};
