...
import { SystemAdministratorListPage as ShowCaseList } from 'pages/system-administrators';
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                <Text as="b" fontSize="xl">
                  Latest System Administrators
                </Text>
                <NextLink href={`system-administrators`} passHref legacyBehavior>
                  <Button
